...
const Experience = () => {
  return (
    <div className='experience-container bg-black w-screen text-white pt-14 pt-16 overflow-x-hidden' id='experience'>
      ...
      <VerticalTimeline className='mt-12'>
        {experiences.map((experience) => (
          ...
          >
            <div>
              <h3 className='text-white text-[25px] font-bold'>{experience.role}</h3>
              <p
